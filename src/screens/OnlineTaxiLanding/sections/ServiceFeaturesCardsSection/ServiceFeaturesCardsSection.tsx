      ...
      <div className="container max-w-[1200px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-10 items-center justify-center lg:justify-between text-center lg:text-left">
          ...
          <div className="w-full lg:w-[539px]">
            <div className="mb-10">
              <h2 className="font-['poppins'] font-semibold text-[#001422] text-2xl min-[767px]:text-3xl lg:text-[42px] xl:text-[48px] leading-[1.2] min-[767px]:leading-[1.3] lg:leading-[1.4] xl:leading-[72px] mb-6">
                We Will Make You Very Special With Our Service
              </h2>
              <p className="font-['poppins'] font-normal text-[#9a9a9a] text-[14px] sm:text-[15px] min-[767px]:text-[16px] leading-[1.5] min-[767px]:leading-[1.6] lg:leading-10 mb-8 max-w-lg mx-auto lg:mx-0">
            ...
            {featureCards.map((card) => (
              ...
              >
                <CardContent className="p-4 min-[767px]:p-6">
                  ...
                  <h3 className="font-['poppins'] font-semibold text-[#001422] text-base min-[767px]:text-lg lg:text-2xl mb-2 min-[767px]:mb-3 text-center lg:text-left">
                    {card.title}
                  </h3>
                  <p className="font-['poppins'] font-normal text-[#9a9a9a] text-[13px] min-[767px]:text-sm leading-[1.4] min-[767px]:leading-6 text-center lg:text-left">
                    {card.description}
                  </p>
                </CardContent>
              </Card>
