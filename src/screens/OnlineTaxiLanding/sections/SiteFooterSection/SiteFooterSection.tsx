      ...
      <div className="container mx-auto max-w-[1200px]">
        <div className="grid grid-cols-1 min-[553px]:grid-cols-2 md:grid-cols-4 gap-6 min-[320px]:gap-8 text-center min-[553px]:text-left">
          ...
          <div className="col-span-1">
            ...
            <div className="[font-family:'poppins'] font-normal text-white text-xs min-[320px]:text-sm min-[553px]:text-base leading-6 min-[320px]:leading-7 min-[553px]:leading-8 md:leading-10 max-w-[536px] mx-auto min-[553px]:mx-0">
          ...
          <div className="col-span-1">
            <div className="mb-6 min-[320px]:mb-7 min-[553px]:mb-8">
              ...
              <p className="[font-family:'poppins'] font-normal text-white text-xs min-[320px]:text-sm min-[553px]:text-base leading-5 min-[320px]:leading-6 min-[553px]:leading-normal">
              ...
              <ul className="space-y-2 min-[320px]:space-y-3 min-[553px]:space-y-4 md:space-y-5">
                {aboutUsLinks.map((link, index) => (
                  <li key={index}>
                    <a
                      href={link.href}
                      className="[font-family:'poppins'] font-normal text-white text-xs min-[320px]:text-sm min-[553px]:text-base transition-colors duration-300 hover:text-white/80"
                    >
                      {link.text}
                    </a>
                  </li>
