    ...
    <section className="w-full py-10 md:py-20 bg-[#f3f3f3] px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col items-center mb-8 min-[770px]:mb-10 md:mb-16 text-center">
          <h2 className="font-semibold text-2xl min-[767px]:text-3xl md:text-[40px] text-[#001422] leading-[1.2] min-[767px]:leading-[1.3] md:leading-[72px] [font-family:'Sora',Helvetica]">
            What Our Customers
            <br />
            Have To Say
          </h2>
          <p className="mt-3 min-[320px]:mt-4 font-normal text-xs min-[320px]:text-sm min-[770px]:text-base text-[#9a9a9a] [font-family:'Sora',Helvetica] leading-5 min-[320px]:leading-6 min-[770px]:leading-7 md:leading-8 max-w-[504px]">
            ...
            >
              <CardContent className="p-4 min-[320px]:p-5 min-[770px]:p-6 md:p-8">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 min-[320px]:ml-4">
                    <p
                      ...
                      } tracking-[0.50px] [font-family:'Sora',Helvetica]`}
                    >
                      {testimonial.name}
                    </p>
                    <p
                      ...
                      } font-normal tracking-[0.50px] [font-family:'Sora',Helvetica]`}
                    >
                      {testimonial.role}
                    </p>
                  </div>
                ...
                <p
                  ...
                  } font-normal text-xs min-[320px]:text-sm min-[770px]:text-base tracking-[0.50px] leading-5 min-[320px]:leading-6 min-[770px]:leading-7 md:leading-10 [font-family:'Sora',Helvetica]`}
                >
                  {testimonial.text}
                </p>
